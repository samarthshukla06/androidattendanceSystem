...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] {"CSE","IT","EEE","CE","ME"};
	...
	private String[] subjectFEString = new String[] {"BD","MC"};
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		System.out.println(subjectFinal);
